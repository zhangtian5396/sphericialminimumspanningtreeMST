...
function [BestSol,Convergence_curve]=MPA(SearchAgents_no,Max_iter,model)
...
Prey=initialization_MPA(SearchAgents_no,dim,ub,lb);
...
while Iter<Max_iter    
 ...
 for i=1:size(Prey,1)  
    ...
    [Prey(i,:),fitness(i,1),Sol(i)]=fobj(Prey(i,:));
